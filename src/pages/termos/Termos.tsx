...
import FotoTermos from "../../assets/imagens/termos.jpeg"

function Termos() {
  return (
    <>
    <Grid>
      <Grid container className="termos-container">
        <Grid
          ...
          padding={4}>
          <Box>
            <Typography className="termos-title" variant="h6">Termos de Uso</Typography>
          </Box>
          <Box>
            <Typography className="termos-conteudo">
              ...
              <p>2. Suspendisse potenti. Proin tristique, sapien in laoreet condimentum, ligula metus mattis purus, ut vehicula ipsum dui in nisi. Maecenas vulputate lectus in turpis suscipit fringilla. Fusce nec iaculis massa. Integer aliquam bibendum felis porta luctus. Phasellus nisi ex, gravida et tristique eget, consectetur ut mi. Donec et dolor porttitor, viverra nisi vitae, aliquam velit. Vivamus sit amet libero bibendum orci suscipit pharetra id non mauris. Nullam vestibulum semper tincidunt. Quisque vulputate sem nibh, laoreet accumsan ligula sodales vel. Donec auctor augue nec commodo dignissim.</p>
        ...
        <Grid
          ...
          padding={8}
          item xs={6}>
          <img className="termos-img" src={FotoTermos} alt="Foto Termos de Uso" />
        </Grid>
