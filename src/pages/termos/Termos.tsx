...
import FotoTermos from "../../assets/imagens/termos.svg"
    ...
    <>
      <Grid>
        <Grid container className="regras-container" direction="row" justifyContent="center" alignItems="center">
          <Grid xs={3}>
            <img src={FotoTermos} alt="Foto de aviso" width={450} />
          </Grid>
          <Grid xs={6} alignItems="center">
            <Box>
              <Typography className="regras-title" variant="h6">Termos de Uso</Typography>
