            ...
            <Grid item xs={6} alignItems='center'>
                <Box>
                    <form onSubmit={onSubmit}>
                        ...
                        <TextField value={user.orientacao} onChange={(e: ChangeEvent<HTMLInputElement>) => updatedModel(e)} id='orientacao' label='orientacao' variant='outlined' name='orientacao' margin='normal' fullWidth />
                        <TextField value={user.pcd} onChange={(e: ChangeEvent<HTMLInputElement>) => updatedModel(e)} id='pcd' label='pcd' variant='outlined' name='pcd' margin='normal' fullWidth />
