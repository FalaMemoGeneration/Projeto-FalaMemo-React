        ...
        <>
            <Grid container direction="row" justifyContent="center" alignItems="center" className='footer-container'>
                ...
                <Grid alignItems="flex-start" justifyContent="flex-start" item xs={3}>
                    <Box>
                        <Typography className="text-title" paddingY={2}>FalaMemo</Typography>
                    </Box>
                ...
                <Grid alignItems="flex-start" justifyContent="flex-start" item xs={3}>
                    <Box>
                        <Typography className="text-title" paddingY={2}>Informações</Typography>
                    </Box>
                    <Link to="/Regras" className="text-decorator-none">
                    <Box>
                        <Typography className="text-style">Regras da Comunidade</Typography>
                    </Box>
                    </Link>
            ...
            <Box>
                        <Box paddingTop={1}>
                            <Typography variant="subtitle2" align="center" gutterBottom className="text-style">FalaMemo© 2022 Copyright:</Typography>
                        </Box>
                        <Box>
                            <a target="_blank" href="https://brasil.generation.org/">
                                <Typography variant="subtitle2" gutterBottom align="center" className="text-style">brasil.generation.org</Typography>
                            </a>
                        </Box>
                    </Box>
            </Grid>
